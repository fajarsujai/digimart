            ...
            <div class="row">
                  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                    <aside class="ps-widget--footer ps-widget--info">
                      <header><a class="ps-logo" href="index.html"><img src="{{ asset('frontend') }}/images/logo.png" alt=""></a>
                        <h3 class="ps-widget__title">Alamat</h3>
                      </header>
                      <footer>
                  ...
                  <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12 ">
                    <aside class="ps-widget--footer ps-widget--link">
                      <header>
                        <h3 class="ps-widget__title">Tentang Toko</h3>
                      </header>
                      <footer>
                  ...
                  <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12 ">
                    <aside class="ps-widget--footer ps-widget--link">
                      <header>
                        <h3 class="ps-widget__title">Kategori Toko</h3>
                      </header>
                      <footer>
                        <ul class="ps-list--line">
